...
class DatasetResultSummaryWindow:
    ...
    def __init__(self, view_dataset_command, view_dataset_with_anomalies_command):
        self.view_dataset_command = view_dataset_command
        self.view_dataset_with_anomalies_command = view_dataset_with_anomalies_command
    ...
    def show_window(self):
        ...
        view_dataset_with_anomalies = tk.Button(frame,
                                                text="View dataset file with detected anomalies",
