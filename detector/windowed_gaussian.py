...
from detector.nab.gaussian.windowedGaussian_detector import WindowedGaussianDetectorNab
...
class WindowedGaussianDetector(BaseDetector, ABC):
    ...
    def predict(self, input_instances):
        ...
        self.model = WindowedGaussianDetectorNab(input_instances, self.__probationary_period)
