...
class BayesChangePtDetectorNab(AnomalyDetector):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(BayesChangePtDetectorNab, self).__init__(*args, **kwargs)
    ...
    def handleRecord(self, inputData):
        ...
        predProbs = self.observationLikelihoood.pdf(inputData)
        ...
        self.observationLikelihoood.updateTheta(inputData)
