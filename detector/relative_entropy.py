...
from detector.nab.relative_entropy.relative_entropy_detector import RelativeEntropyDetectorNab
...
class RelativeEntropyDetector(BaseDetector, ABC):
    ...
    def predict(self, input_instances):
        ...
        self.model = RelativeEntropyDetectorNab(input_instances, self.__probationary_period)
